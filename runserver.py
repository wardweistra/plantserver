from plantserver import app
import socket
import argparse
import webbrowser

parser = argparse.ArgumentParser(description='Launch the PlantServer')
parser.add_argument('--debug', action="store_true", default=False, help="Run in debug mode")
parser.add_argument('--host', default='localhost', help="Set host to listen on.")
parser.add_argument('--port', type=int, default=75268,
                    help="Set port to try to listen to. Tries 75268 by default. If busy "
